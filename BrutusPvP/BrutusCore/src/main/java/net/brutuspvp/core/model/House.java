...
public class House extends LivingSpace {
	...
	public House(ProtectedCuboidRegion area, World world, String name) {
		super(area, world, name, Type.HOUSE);
	}
	
	public House(ProtectedCuboidRegion area, World world, String name, int price) {
		super(area, world, name, Type.HOUSE, price);
	}
