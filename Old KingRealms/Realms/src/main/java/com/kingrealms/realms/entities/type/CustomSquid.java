...
public class CustomSquid extends EntitySquid implements ICustomEntity {
    ...
    public LootTable getDropTable() {
        LootTable lootTable = new EntityLootTable(EntityType.SQUID);
        lootTable.addPossibleLoot(new RealmsLoot(CustomItemRegistry.INK_SAC, Rarity.COMMON));
        return lootTable;
    }
