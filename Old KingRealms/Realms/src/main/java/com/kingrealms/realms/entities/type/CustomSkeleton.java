...
public class CustomSkeleton extends EntitySkeleton implements ICustomEntity {
    ...
    public LootTable getDropTable() {
        LootTable lootTable = new EntityLootTable(EntityType.SKELETON);
        lootTable.addPossibleLoot(new RealmsLoot(CustomItemRegistry.BONE, Rarity.COMMON));
        lootTable.addPossibleLoot(new RealmsLoot(CustomItemRegistry.ARROW, Rarity.UNCOMMON));
        lootTable.addPossibleLoot(new RealmsLoot(CustomItemRegistry.BOW, Rarity.EPIC));
        lootTable.addPossibleLoot(new RealmsLoot(CustomItemRegistry.SKELETON_HEAD, Rarity.EPIC));
        return lootTable;
    }
