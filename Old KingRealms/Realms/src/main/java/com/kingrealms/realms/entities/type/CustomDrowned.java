...
public class CustomDrowned extends EntityDrowned implements ICustomEntity {
    private boolean custom = false;
    
    public CustomDrowned(World world) {
    ...
    public LootTable getDropTable() {
        LootTable lootTable = new EntityLootTable(EntityType.DROWNED);
        lootTable.addPossibleLoot(new RealmsLoot(CustomItemRegistry.ROTTEN_FLESH, Rarity.COMMON));
        lootTable.addPossibleLoot(new RealmsLoot(CustomItemRegistry.GOLD, Rarity.RARE)); 
        lootTable.addPossibleLoot(new RealmsLoot(CustomItemRegistry.TRIDENT, Rarity.ULTRA_LEGENDARY));
        return lootTable;
    }
