...
public class CustomZoglin extends EntityZoglin implements ICustomEntity {
    private boolean custom = false;
    
    public CustomZoglin(World world) {
    ...
    public LootTable getDropTable() {
        LootTable lootTable = new EntityLootTable(EntityType.ZOGLIN);
