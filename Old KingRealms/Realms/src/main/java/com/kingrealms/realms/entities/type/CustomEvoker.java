...
public class CustomEvoker extends EntityEvoker implements ICustomEntity {
    private boolean custom = false;
    
    public CustomEvoker(World world) {
    ...
    public LootTable getDropTable() {
        LootTable lootTable = new EntityLootTable(EntityType.EVOKER);
        lootTable.addPossibleLoot(new RealmsLoot(CustomItemRegistry.EMERALD, Rarity.UNCOMMON));
        lootTable.addPossibleLoot(new RealmsLoot(CustomItemRegistry.TOTEM_OF_UNDYING, Rarity.ULTRA_LEGENDARY));
        return lootTable;
    }
