...
public class CustomVex extends EntityVex implements ICustomEntity {
    ...
    public LootTable getDropTable() {
        LootTable lootTable = new EntityLootTable(EntityType.VEX);
        lootTable.addPossibleLoot(new RealmsLoot(CustomItemRegistry.IRON_SWORD, Rarity.UNCOMMON));
        lootTable.addPossibleLoot(new RealmsLoot(CustomItemRegistry.FEATHER, Rarity.COMMON));
        lootTable.addPossibleLoot(new RealmsLoot(CustomItemRegistry.IRON, Rarity.UNCOMMON));
        return lootTable;
    }
