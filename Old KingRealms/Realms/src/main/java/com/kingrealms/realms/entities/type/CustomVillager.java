...
public class CustomVillager extends EntityVillager implements ICustomEntity {
    ...
    public LootTable getDropTable() {
        LootTable lootTable = new EntityLootTable(EntityType.VILLAGER);
        lootTable.addPossibleLoot(new RealmsLoot(CustomItemRegistry.EMERALD, Rarity.UNCOMMON));
        //TODO Trade drops, requires a different mob stack handler
        return lootTable;
    }
