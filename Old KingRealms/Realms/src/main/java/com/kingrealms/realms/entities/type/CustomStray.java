...
public class CustomStray extends EntitySkeletonStray implements ICustomEntity {
    private boolean custom = false;
    
    public CustomStray(World world) {
    ...
    public LootTable getDropTable() {
        LootTable lootTable = new EntityLootTable(EntityType.STRAY);
        lootTable.addPossibleLoot(new RealmsLoot(CustomItemRegistry.BONE, Rarity.COMMON));
        lootTable.addPossibleLoot(new RealmsLoot(CustomItemRegistry.TIPPED_ARROW, Rarity.RARE));
        lootTable.addPossibleLoot(new RealmsLoot(CustomItemRegistry.BOW, Rarity.RARE));
        return lootTable;
    }
