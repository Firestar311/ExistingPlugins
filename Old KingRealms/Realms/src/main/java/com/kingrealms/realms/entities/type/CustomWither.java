...
public class CustomWither extends EntityWither implements ICustomEntity {
    ...
    public LootTable getDropTable() {
        LootTable lootTable = new EntityLootTable(EntityType.WITHER);
        lootTable.addPossibleLoot(new RealmsLoot(CustomItemRegistry.NETHER_STAR, Rarity.COMMON));
        lootTable.addPossibleLoot(new RealmsLoot(CustomItemRegistry.WITHER_ROSE, Rarity.COMMON));
        return lootTable;
    }
