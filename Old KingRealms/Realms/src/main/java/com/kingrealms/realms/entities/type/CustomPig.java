...
public class CustomPig extends EntityPig implements ICustomEntity {
    ...
    public LootTable getDropTable() {
        LootTable lootTable = new EntityLootTable(EntityType.PIG);
        lootTable.addPossibleLoot(new RealmsLoot(CustomItemRegistry.RAW_PORKCHOP, Rarity.COMMON));
        lootTable.addPossibleLoot(new RealmsLoot(CustomItemRegistry.PINK_DYE, Rarity.UNCOMMON));
        return lootTable;
    }
