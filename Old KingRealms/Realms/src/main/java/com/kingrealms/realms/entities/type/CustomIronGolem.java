...
public class CustomIronGolem extends EntityIronGolem implements ICustomEntity {
    ...
    public LootTable getDropTable() {
        LootTable lootTable = new EntityLootTable(EntityType.IRON_GOLEM);
        lootTable.addPossibleLoot(new RealmsLoot(CustomItemRegistry.POPPY, Rarity.COMMON));
        lootTable.addPossibleLoot(new RealmsLoot(CustomItemRegistry.IRON, Rarity.RARE));
        lootTable.addPossibleLoot(new RealmsLoot(CustomItemRegistry.SPAWNER_SHARDS.getItem(EntityType.IRON_GOLEM), Rarity.LEGENDARY));
        return lootTable;
    }
