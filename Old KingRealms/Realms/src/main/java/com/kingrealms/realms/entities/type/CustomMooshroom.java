...
public class CustomMooshroom extends EntityMushroomCow implements ICustomEntity {
    ...
    public LootTable getDropTable() {
        LootTable lootTable = new EntityLootTable(EntityType.MUSHROOM_COW);
        ...
        lootTable.addPossibleLoot(new RealmsLoot(CustomItemRegistry.RED_MUSHROOM, Rarity.RARE));
        lootTable.addPossibleLoot(new RealmsLoot(CustomItemRegistry.BROWN_MUSHROOM, Rarity.RARE));
        return lootTable;
    }
