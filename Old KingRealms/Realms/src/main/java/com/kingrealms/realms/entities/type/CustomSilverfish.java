...
public class CustomSilverfish extends EntitySilverfish implements ICustomEntity {
    ...
    public LootTable getDropTable() {
        LootTable lootTable = new EntityLootTable(EntityType.SILVERFISH);
        lootTable.addPossibleLoot(new RealmsLoot(CustomItemRegistry.IRON_NUGGET, Rarity.UNCOMMON));
        lootTable.addPossibleLoot(new RealmsLoot(CustomItemRegistry.GRAY_DYE, Rarity.COMMON));
        return lootTable;
    }
