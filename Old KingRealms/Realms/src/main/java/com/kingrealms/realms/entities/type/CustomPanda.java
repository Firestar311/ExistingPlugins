...
public class CustomPanda extends EntityPanda implements ICustomEntity {
    ...
    public LootTable getDropTable() {
        LootTable lootTable = new EntityLootTable(EntityType.PANDA);
        lootTable.addPossibleLoot(new RealmsLoot(CustomItemRegistry.BAMBOO, Rarity.COMMON));
        ...
        lootTable.addPossibleLoot(new RealmsLoot(CustomItemRegistry.COCO_BEANS, Rarity.EPIC));
        return lootTable;
    }
