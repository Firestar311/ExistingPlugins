...
public class CustomPhantom extends EntityPhantom implements ICustomEntity {
    private boolean custom = false;
    
    public CustomPhantom(World world) {
    ...
    public LootTable getDropTable() {
        LootTable lootTable = new EntityLootTable(EntityType.PHANTOM);
        lootTable.addPossibleLoot(new RealmsLoot(CustomItemRegistry.PHANTOM_MEMBRANE, Rarity.UNCOMMON));
