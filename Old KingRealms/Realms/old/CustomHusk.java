...
public class CustomHusk extends EntityZombieHusk implements ICustomEntity {
    private boolean custom = false;
    
    public CustomHusk(World world) {
    ...
    public LootTable getDropTable() {
        LootTable lootTable = new EntityLootTable(EntityType.HUSK);
        ...
        lootTable.addPossibleLoot(new RealmsLoot(CustomItemRegistry.SAND, Rarity.RARE));
        return lootTable;
    }
