...
public class CustomHorse extends EntityHorse implements ICustomEntity {
    ...
    public LootTable getDropTable() {
        ...
        lootTable.addPossibleLoot(new RealmsLoot(CustomItemRegistry.SADDLE, Rarity.RARE));
        lootTable.addPossibleLoot(new RealmsLoot(CustomItemRegistry.LEAD, Rarity.RARE));
        return lootTable;
    }
