...
public class CustomSpider extends EntitySpider implements ICustomEntity {
    ...
    public LootTable getDropTable() {
        LootTable lootTable = new EntityLootTable(EntityType.SPIDER);
        lootTable.addPossibleLoot(new RealmsLoot(CustomItemRegistry.STRING, Rarity.COMMON));
        lootTable.addPossibleLoot(new RealmsLoot(CustomItemRegistry.SPIDER_EYE, Rarity.UNCOMMON));
        return lootTable;
    }
