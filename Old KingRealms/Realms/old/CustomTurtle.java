...
public class CustomTurtle extends EntityTurtle implements ICustomEntity {
    private boolean custom = false;
    
    public CustomTurtle(World world) {
    ...
    public LootTable getDropTable() {
        LootTable lootTable = new EntityLootTable(EntityType.TURTLE);
        lootTable.addPossibleLoot(new RealmsLoot(CustomItemRegistry.SCUTE, Rarity.RARE));
        lootTable.addPossibleLoot(new RealmsLoot(CustomItemRegistry.SEAGRASS, Rarity.UNCOMMON));
