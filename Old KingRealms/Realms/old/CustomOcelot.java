...
public class CustomOcelot extends EntityOcelot implements ICustomEntity {
    ...
    public LootTable getDropTable() {
        LootTable lootTable = new EntityLootTable(EntityType.OCELOT);
        lootTable.addPossibleLoot(new RealmsLoot(CustomItemRegistry.YELLOW_DYE, Rarity.COMMON));
        lootTable.addPossibleLoot(new RealmsLoot(CustomItemRegistry.RAW_COD, Rarity.UNCOMMON));
        lootTable.addPossibleLoot(new RealmsLoot(CustomItemRegistry.RAW_SALMON, Rarity.UNCOMMON));
        lootTable.addPossibleLoot(new RealmsLoot(CustomItemRegistry.GUNPOWDER, Rarity.RARE));
        return lootTable;
    }
