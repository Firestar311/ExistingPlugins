...
public class CustomLlama extends EntityLlama implements ICustomEntity {
    private boolean custom = false;
    
    public CustomLlama(World world) {
    ...
    public LootTable getDropTable() {
        LootTable lootTable = new EntityLootTable(EntityType.LLAMA);
        lootTable.addPossibleLoot(new RealmsLoot(CustomItemRegistry.LEATHER, Rarity.COMMON));
        lootTable.addPossibleLoot(new RealmsLoot(CustomItemRegistry.SLIME_BALL, Rarity.UNCOMMON));
        return lootTable;
    }
