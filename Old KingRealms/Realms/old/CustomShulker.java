...
public class CustomShulker extends EntityShulker implements ICustomEntity {
    ...
    public LootTable getDropTable() {
        LootTable lootTable = new EntityLootTable(EntityType.SHULKER);
        lootTable.addPossibleLoot(new RealmsLoot(CustomItemRegistry.SHULKER_SHELL, Rarity.RARE));
        lootTable.addPossibleLoot(new RealmsLoot(CustomItemRegistry.LEVITATION_ARROW, Rarity.UNCOMMON));
        lootTable.addPossibleLoot(new RealmsLoot(CustomItemRegistry.PURPUR_BLOCK, Rarity.UNCOMMON));
        return lootTable;
    }
