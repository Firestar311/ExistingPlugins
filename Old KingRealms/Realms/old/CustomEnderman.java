...
public class CustomEnderman extends EntityEnderman implements ICustomEntity {
    ...
    public LootTable getDropTable() {
        LootTable lootTable = new EntityLootTable(EntityType.ENDERMAN);
        lootTable.addPossibleLoot(new RealmsLoot(CustomItemRegistry.ENDER_PEARL, Rarity.COMMON));
        lootTable.addPossibleLoot(new RealmsLoot(CustomItemRegistry.END_STONE, Rarity.UNCOMMON));
        return lootTable;
    }
