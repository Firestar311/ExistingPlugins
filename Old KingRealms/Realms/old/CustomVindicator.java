...
public class CustomVindicator extends EntityVindicator implements ICustomEntity {
    ...
    public LootTable getDropTable() {
        LootTable lootTable = new EntityLootTable(EntityType.VINDICATOR);
        lootTable.addPossibleLoot(new RealmsLoot(CustomItemRegistry.IRON_AXE, Rarity.UNCOMMON));
        lootTable.addPossibleLoot(new RealmsLoot(CustomItemRegistry.EMERALD, Rarity.RARE));
        return lootTable;
    }
