...
public class CustomPillager extends EntityPillager implements ICustomEntity {
    private boolean custom = false;
    
    public CustomPillager(World world) {
    ...
    public LootTable getDropTable() {
        LootTable lootTable = new EntityLootTable(EntityType.PILLAGER);
        lootTable.addPossibleLoot(new RealmsLoot(CustomItemRegistry.CROSS_BOW, Rarity.RARE));
        ...
        lootTable.addPossibleLoot(new RealmsLoot(CustomItemRegistry.BAD_OMEN, Rarity.EPIC));
        lootTable.addPossibleLoot(new RealmsLoot(CustomItemRegistry.SPAWNER_SHARDS.getItem(EntityType.VILLAGER), Rarity.LEGENDARY));
        return lootTable;
    }
