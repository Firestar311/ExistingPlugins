...
public class CustomEndermite extends EntityEndermite implements ICustomEntity {
    ...
    public LootTable getDropTable() {
        LootTable lootTable = new EntityLootTable(EntityType.ENDERMITE);
        lootTable.addPossibleLoot(new RealmsLoot(CustomItemRegistry.PURPLE_DYE, Rarity.UNCOMMON));
        lootTable.addPossibleLoot(new RealmsLoot(CustomItemRegistry.CHORUS, Rarity.COMMON));
        return lootTable;
    }
