...
public class Perms {
    ...
    public static final String FLAG_IGNORE_REASON = "enforcer.command.flag.ignorereason";
    ...
    public static final String MRULES_VIOLATIONS_CLEAR = "enforcer.rules.violations.clear";
    public static final String MRULES_VIOLATIONS_CREATE = "enforcer.rules.violations.create";
    public static final String MRULES_VIOLATIONS_LENGTH = "enforcer.rules.violations.length";
    public static final String MRULES_VIOLATIONS_LIST = "enforcer.rules.violations.list";
    public static final String MRULES_VIOLATIONS_MAIN = "enforcer.rules.violations.main";
    public static final String MRULES_VIOLATIONS_PUNISHMENTS = "enforcer.rules.violations.punishments";
    public static final String MRULES_VIOLATIONS_PUNISHMENTS_ADD = "enforcer.rules.violations.punishments.add";
    public static final String MRULES_VIOLATIONS_PUNISHMENTS_CLEAR = "enforcer.rules.violations.punishments.clear";
    public static final String MRULES_VIOLATIONS_PUNISHMENTS_LIST = "enforcer.rules.violations.punishments.list";
    public static final String MRULES_VIOLATIONS_PUNISHMENTS_REMOVE = "enforcer.rules.violations.punishments.remove";
    public static final String MRULES_VIOLATIONS_REMOVE = "enforcer.rules.violations.remove";
    public static final String MRULES_OFFESNES_PUNISHMENTS_LIST = "enforcer.rules.violations.punishments.list";
    ...
    public static final String MRULES_SET_PLAYER_DESCRIPTION = "enforcer.rules.set.playerdescription";
    ...
    public static final String WAVE_ACTIVATE = "enforcer.waves.admin.activate";
    public static final String WAVE_APPROVE = "enforcer.waves.admin.approve";
    public static final String WAVE_ASSIGN = "enforcer.waves.admin.assign";
    public static final String WAVE_LIST = "enforcer.waves.admin.list";
    public static final String WAVE_REJECT = "enforcer.waves.admin.reject";
    public static final String WAVE_REVIEW = "enforcer.waves.admin.review";
}