...
public class UpdateChecker {
    ...
    public void setGoSilent(boolean goSilent) {
        this.goSilent = goSilent;
    }

    public void setLastDownload(PluginInformation lastDownload) {
        this.lastDownload = lastDownload;
    }

    public void setUpdate(DisguiseUpdate update) {
        this.update = update;
    }
    ...
    public LDGithub getGithubUpdater() {
        return githubUpdater;
    }

    public LDJenkins getJenkinsUpdater() {
        return jenkinsUpdater;
    }
