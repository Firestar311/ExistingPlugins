package net.firecraftmc.maniacore.spigot.mutations.types;

import me.libraryaddict.disguise.disguisetypes.DisguiseType;
import net.firecraftmc.maniacore.spigot.mutations.DefenseType;
import net.firecraftmc.maniacore.spigot.mutations.Mutation;
import net.firecraftmc.maniacore.spigot.mutations.MutationType;
import net.firecraftmc.maniacore.spigot.util.ArmorSlot;
