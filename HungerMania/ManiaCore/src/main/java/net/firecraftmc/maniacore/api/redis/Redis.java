...
public class Redis {
    ...
    public static void pushFriendship(net.firecraftmc.maniacore.api.friends.Friendship friendship) {
        try (Jedis jedis = getConnection()) {
            Map<String, String> data = new HashMap<>();
    ...
    public static net.firecraftmc.maniacore.api.friends.Friendship getFriendship(int id) {
        try (Jedis jedis = getConnection()) {
            Map<String, String> data = jedis.hgetAll(getNetworkType() + "~FRIENDSHIP:" + id);
            if (!data.isEmpty()) {
                return new net.firecraftmc.maniacore.api.friends.Friendship(data);
            }
        }
        return null;
    }
    
    public static List<net.firecraftmc.maniacore.api.friends.Friendship> getFriendships() {
        List<net.firecraftmc.maniacore.api.friends.Friendship> friendships = new ArrayList<>();
        try (Jedis jedis = getConnection()) {
            for (String key : jedis.keys(getNetworkType() + "~FRIENDSHIP:*")) {
                ...
                if (!data.isEmpty()) {
                    friendships.add(new net.firecraftmc.maniacore.api.friends.Friendship(data));
                }
            }
        }
        return friendships;
    ...
    public static void pushFriendRequest(net.firecraftmc.maniacore.api.friends.FriendRequest request) {
        try (Jedis jedis = getConnection()) {
            Map<String, String> data = new HashMap<>();
    ...
    public static net.firecraftmc.maniacore.api.friends.FriendRequest getFriendRequest(int id) {
        try (Jedis jedis = getConnection()) {
            Map<String, String> data = jedis.hgetAll(getNetworkType() + "~FRIENDREQUEST:" + id);
            if (!data.isEmpty()) {
                return new net.firecraftmc.maniacore.api.friends.FriendRequest(data);
            }
        }
    ...
    public static List<net.firecraftmc.maniacore.api.friends.FriendRequest> getFriendRequests() {
        List<net.firecraftmc.maniacore.api.friends.FriendRequest> friendRequests = new ArrayList<>();
        try (Jedis jedis = getConnection()) {
            for (String key : jedis.keys(getNetworkType() + "~FRIENDREQUEST:*")) {
                ...
                if (!data.isEmpty()) {
                    friendRequests.add(new net.firecraftmc.maniacore.api.friends.FriendRequest(data));
                }
            }
        }
    ...
    public static void pushFriendNotification(net.firecraftmc.maniacore.api.friends.FriendNotification notification) {
        try (Jedis jedis = getConnection()) {
            Map<String, String> data = new HashMap<>();
    ...
    public static net.firecraftmc.maniacore.api.friends.FriendNotification getFriendNotification(int id) {
        try (Jedis jedis = getConnection()) {
            Map<String, String> data = jedis.hgetAll(getNetworkType() + "~FRIENDNOTIFICATION:" + id);
            if (!data.isEmpty()) {
                return new net.firecraftmc.maniacore.api.friends.FriendNotification(data);
            }
        }
        return null;
    }
    
    public static List<net.firecraftmc.maniacore.api.friends.FriendNotification> getFriendNotifications() {
        List<net.firecraftmc.maniacore.api.friends.FriendNotification> friendNotifications = new ArrayList<>();
        try (Jedis jedis = getConnection()) {
